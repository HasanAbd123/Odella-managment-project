...
selector:row =>row.email
  ...
  },
 {
  ...
  const handledelet = async (id,e)=>{
    ...
    e.preventDefault();
    try{
      const resp= await axios.delete(`https://yaamen1.com/api/supervisors/${id}`,{
  ...
  const [searchTerm, setSearchTerm] = useState('');
    ...
    <Link to={`/admin/listsopervisor/addsopervisor `}style={{textDecoration:"none"}}>
...
export default Datalistsopervisor